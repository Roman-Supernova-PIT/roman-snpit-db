...
import snpit_utils.db


def test_create_get_provenance( dbclient ):
    wayupstream = snpit_utils.db.Provenance( process="proc0", major=1, minor=0 )
    upstream2 = snpit_utils.db.Provenance( process="proc1", major=42, minor=13 )
    upstream1 = snpit_utils.db.Provenance( process="proc2", major=64, minor=128, upstreams=[ wayupstream ] )
    upstream1a = snpit_utils.db.Provenance( process="proc2", major=256, minor=128, upstreams=[ wayupstream ] )
    downstream = snpit_utils.db.Provenance( process="proc3", major=23, minor=64738,
