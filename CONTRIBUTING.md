Contributing to roman-snpit-db
================================================
...
system and the Python, NumPy, and `roman-snpit-db` versions you are using.

Contributing Code and Documentation
-----------------------------------

So you are interested in contributing to the roman-snpit-db Project?  Excellent!
...
from GitHub users' forks of roman-snpit-db If you are new to this
